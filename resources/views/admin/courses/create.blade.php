                ...
                <form action="{{route('courses.store')}}" method="post" class="w-full h-full flex flex-row-reverse">
                    ...
                    <div class="w-1/2 h-full flex flex-col items-end pr-20 relative">
                        ...
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <input type="text" name="field" value="{{old('field')}}" id="field" class="w-2/5 h-8 rounded outline-0 p-2 border border-gray-400">
                            @error('field')
                                <p class="text-red-700">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <input type="date" name="start" value="{{old('start')}}" id="start" class="w-2/5 h-8 rounded outline-0 p-2 border border-gray-400">
                            @error('start')
                                <p class="text-red-700">{{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="w-1/2 h-full flex flex-col items-end pr-20">
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <input type="text" name="teacher" value="{{old('teacher')}}" id="teacher" class="w-2/5 h-8 rounded outline-0 p-2 border border-gray-400">
                            @error('teacher')
                            <p class="text-red-700">{{$message}}</p>
                            @enderror
                        </div>
